...
>[!theo] Theorem.  2.2
>$x \sim N(0, I_p)$. Then, for $0 \leq \varepsilon \leq \sqrt{p}$,
>$$
>\mathrm{P} \left\{ x \in \mathbb{R}^p : | \|x\| - \sqrt{p} | \geq \varepsilon \right\} \leq 2 \exp \left( -\frac{\varepsilon^2}{16} \right),
>$$
...
***Step 3***
>[!lemma] Lemma.
>**Lemma 2.5.** Let $t \sim N(0,1)$ be a one-dimensional standard Gaussian random variable. Then
>$$
>E [\exp(\lambda(t^2 - 1))] \leq \exp(4\lambda^2) \quad \text{for all} \quad |\lambda| \leq \frac{1}{4}.
>$$
